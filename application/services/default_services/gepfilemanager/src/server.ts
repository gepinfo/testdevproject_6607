...
class App {
    ...
    private DatabaseCredentials() {
        ...
        SCMconfig.SCMData( async result => {
            this.DB_Url = result.data.DB_URL_testdevproject_6607;
            let db_auth = result.data.DB_AUTH_testdevproject_6607;
            let db_coll = result.data.DB_COLL_testdevproject_6607;
